...
export const epreuves: Epreuve[] = [
  {
    ...
    logo: "🎧",
    couleur: "#3b82f6",
    theme: "Openings d'animes cultes",
    type: "blind-test",
    questions: [
      {
        id: "bt-1",
        prompt: "Devine l'anime à partir de cet opening.",
        audioSrc: "/audio/opening-1.mp3",
        answer: "One Piece",
      },
      {
        id: "bt-2",
        prompt: "Devine l'anime à partir de cet opening.",
        audioSrc: "/audio/opening-2.mp3",
        answer: "Naruto",
      },
      {
        id: "bt-3",
        prompt: "Devine l'anime à partir de cet opening.",
        audioSrc: "/audio/opening-3.mp3",
